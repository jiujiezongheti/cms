...
<ul>
	<li>
		<a onclick="admin_top_nav(1)" id='nav1' href="sidebar.php" target='sidebar' class="selected">首页</a>
	</li>
	<li>
		<a onclick="admin_top_nav(2)" id='nav2' href="sidebarn.php" target='sidebar'>内容</a>
	</li>
	<li>
